 ...
 * A la derecha, un globo interactivo centrado en el Perú.
 */
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-center lg:gap-16">
        <div>
          ...
          <div
            className={
              featured
                ? 'grid grid-cols-2 gap-4 auto-rows-[minmax(9rem,1fr)] lg:grid-cols-3 lg:auto-rows-[minmax(12rem,1fr)]'
              ...
              return (
                <Link
                  ...
                  className={`group relative isolate overflow-hidden rounded-2xl ${
                    isBig ? 'col-span-2 row-span-2' : featured ? '' : 'aspect-[4/3]'
                  }`}
                >
                  <Image
                    src={
        ...
        {/* Globo: decorativo pero ubicado — abre mirando al Perú y se puede girar. */}
